    ...
    <div class="updated updatedpro mtb16 p0">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php
                    $path = JUSTIN_PLUGFOLDER . '/public/partials/morkvanp-plugin-invoices-page.php';
                    if ( ! file_exists( $path ) ) { ?>
                        <a href="plugin-install.php?tab=plugin-information&amp;plugin=nova-poshta-ttn&amp;section=changelog&amp;TB_iframe=true&amp;width=772&amp;height=374"
                            class="thickbox open-plugin-details-modal" >встановити останню версію плагіна</a>
                        <?php }
                    else{ ?>
                        <a href="plugin-install.php?tab=plugin-information&amp;plugin=nova-poshta-ttn-pro&amp;section=changelog&amp;TB_iframe=true&amp;width=772&amp;height=374"
                            class="thickbox open-plugin-details-modal" >встановити останню версію плагіна</a>
                <?php } ?>
            </div>
        </div>
